...
export default function MyEventListScreen(){
    ...
    <View style={styles.container}>
        ...
        <View style={styles.textWrapper2}>
          <View style={styles.textWrapper}>
              <Text style={styles.textWrpTxt}>My Event List</Text>
          </View>
            <FlatList
              data={getData}
              ...
              <Card containerStyle={{borderRadius:20, margin:10, maxWidth:"100%", width:360}}>
                ...
                <Text style={{fontSize:16, marginBottom:5}}>
                  ...
                  <View style={{flexDirection:'row', justifyContent:'flex-end', marginTop:5}}>
                    <TouchableOpacity style={{backgroundColor: 'black',borderRadius:5, margin: 5, padding: 10, width:100}} onPress={()=> navigation.navigate("EDetail",{ item })}>
